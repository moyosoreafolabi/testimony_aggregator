      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
        <div className="max-w-xl w-full mx-auto">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-slate-900 mb-2">Testimony Analyzer</h1>
            <p className="text-slate-500">Upload your GLT Testimony CSV to categorize and separate stories.</p>
          </div>
                    ...
                    return (
                      <tr key={i} className="hover:bg-slate-50">
                        <td className="px-6 py-3">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${row.Category === 'Others'
